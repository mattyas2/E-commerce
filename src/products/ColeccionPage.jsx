           ...
           <div className="grid gap-8 md:grid-cols-2">
             ...
             <div className="grid gap-4 lg:grid-cols-5">
               ...
               <div className="relative overflow-hidden rounded-lg bg-gray-100 lg:col-span-4">
                 ...
                 <div  className="absolute right-4 top-4 inline-block rounded-lg border bg-white px-3.5 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:text-gray-700 md:text-base">
             ...
             <div className="md:py-4 col-12">
               ...
               <div className="mb-6 flex items-center md:mb-10">
                 ...
                 <div className="ml-4 text-sm font-semibold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">view all 47 reviews</div>
               </div>

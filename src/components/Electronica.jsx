...
return(
    ...
    <>
      ...
      <div className="text-center font-bold text-2xl flex bg-teal-50 justify-center gap-20 mb-10 max-sm:justify-center items-center max-sm:gap-16 max-sm:mx-4">

 Electronica
</div>
               
<div className="flex flex-col gap-10 bg-teal-50 h-[100%] ">
      <div className="w-[100%] flex gap-10 mx-7 max-sm:flex max-sm:justify-center max-sm:flex-wrap max-sm:w-[100%] max-sm:mx-0">
      {loaded &&
           productos.length > 0 &&
...
<div className="w-[100%] gap-10 mx-7 max-sm:mx-0 flex max-sm:flex max-sm:flex-wrap max-sm:justify-center max-sm:w-[100%]  ">

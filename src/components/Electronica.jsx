...
<div className="w-[32%] gap-10 mx-7 flex max-sm:flex max-sm:flex-wrap max-sm:w-[100%]  ">

{loaded &&
           coleccion.length > 0 &&
           coleccion.map((producto) => (
            <div
              className="bg-purple-50  flex flex-col justify-center items-center max-sm:mx-4  mt-5 mb-10 w-[70%] h-[400px] rounded-xl shadow-2xl  "
              key={producto.id}
            >
              <div className="flex justify-center items-center">
                <Tilt

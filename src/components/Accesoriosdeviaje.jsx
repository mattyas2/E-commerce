...
export const AccesoriosDeViajes = ()=>{
    const [loaded, setLoaded] = useState(false);
  
    
    const {
      productos, setProductos,coleccion,setColeccion,favorites,onAddProduct,onDeleteFavort,addToFavorites, user,alertMessages, alertType, showAlerta, 
  ...
  useEffect(() => {
    ...
    const coleccions = async ()=>{
        ...
        const db = getFirestore(app)
            ...
            const querySnapshot = await getDocs( query(citiesRef, where("category", "==", "viaje")))  
            const newImpresion = [];

...
export const Footer =()=>{
  ...
  <div className="container  justify-center  flex  items-center sm:flex-row flex-col" _msthidden="2">
    <div className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" _msthidden="1">
      ...
      <span className="ml-4 text-xl text-gray-400" >Mr. Mattyas</span>
    </div>
    <div className="text-sm flex text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4" _msttexthash="2994290" _msthidden="1" _msthash="1326">© 2020 Mr. Mattyas  —
      <div  className="text-gray-600 ml-2" rel="noopener noreferrer" target="_blank">@Mattyas</div>
    </div>

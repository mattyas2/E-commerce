...
<div className="flex w-[100%] gap-10 flex-wrap bg-teal-50 h-[100%] mt-10">
      <div className="w-[100%] flex max-sm:flex max-sm:flex-wrap max-sm:w-[100%]">
      {loaded &&
           productos.length > 0 &&
           productos.map((producto) => (
            <div key={producto.id} className="relative  mx-4 mt-4 mb-6 rounded-xl shadow-2xl w-[340px] flex flex-col justify-center  bg-purple-50  h-[535px]">
